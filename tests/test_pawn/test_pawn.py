...
def test_pawn_double_move(chess_board_reader: ChessBoardReader) -> None:
    ...
    black_pawn_moves = chess_engine.get_piece((1, 0)).get_moves()
    white_pawn_moves = chess_engine.get_piece((6, 0)).get_moves()
...
def test_pawn_capture(chess_board_reader: ChessBoardReader) -> None:
    ...
    black_pawn_moves = chess_engine.get_piece((3, 1)).get_moves()
    white_pawn_moves = chess_engine.get_piece((4, 0)).get_moves()
